...
const
  ...
  Dir = 'C:\Arq\Work_at_LNLS\IMA\Bobina de Helmholtz v5\Resultados\';
  CR = #13;
  CRLF = #13#10;
...
uses Helmholtz_v5, Conexoes, ConfGeral, ConfBob, Offset, Medicao, Motores;
...
begin
     ArqReg := TRegIniFile.Create('Software\Helmholtz_v5');
     Try
...
begin
    ...
    {Configurações Gerais - Driver e Motor}
     ...
     Nome := 'TemperaturaBloco';
     LerRegistro(Nome,Valor);
     TemperaturaBloco := Valor;
...
begin
   ...
   GravarRegistro('NumeroBloco','1');
   GravarRegistro('TemperaturaBloco','23');
   ...
   GravarRegistro('DirAnterior', '0');
   GravarRegistro('Arquivo_Resumo','C:\Arq\Work_at_LNLS\IMA\Bobina de Helmholtz v5\Resultados\Resumo_Helmholtz.dat');
end;
...
//  AssignFile(Arq,'C:\Arq\Work_at_LNLS\IMA\Bobina de Helmholtz v5\outIN.dat');
//  Reset(Arq);
