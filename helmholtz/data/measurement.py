...
class MeasurementData(_database.DatabaseAndFileDocument):
    ...
    db_dict = _collections.OrderedDict([
        ...
        ('coil_id', {'field': 'coil_id', 'dtype': int}),
        ('motor_integrator_id',{'field': 'motor_integrator_id', 'dtype': int}),
        ...
        ('integrated_voltage', {'field': 'integrated_voltage', 'dtype': str}),
    ])
    ...
    def get_magnetization_components(
            self, integrated_voltage_step1, integrated_voltage_step2,
        ...
        mz, mx2, mz_std, mx2_std = self.calc_magnetization(
